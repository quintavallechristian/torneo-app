...
async function main() {
  console.log("📍 Inizio creazione places...\n");

  // 1. Recupera i giochi con bgg_rank < 100 (per le collection)
  ...
  // 3. Aggiungi 10 giochi alla collection di ogni place
  ...
  // Riepilogo
  console.log("🎉 Creazione places completata con successo!\n");
  console.log("📊 Riepilogo:");
  console.log(`   - Places creati: ${createdPlaces.length}`);
  console.log(`   - Giochi nelle collection: ${createdPlacesGames.length}`);
  console.log(`   - Giochi disponibili: ${games.length} (con BGG rank < 100)`);

        ...
        <section className="mt-8">
          ...
          {match.players && match.players.length > 0 ? (
            <div className="space-y-4">
              {match.players.map((playerObj: any) => (
                <SpotlightCard className="flex items-center gap-4 my-2 px-2 py-2 shadow-xl border-indigo-200 bg-gradient-to-br from-white to-indigo-50 dark:from-gray-900 dark:to-gray-800" spotlightColor="rgba(0, 229, 255, 0.2)" key={playerObj.profile?.id}>
                  <div>
                                    <Image
